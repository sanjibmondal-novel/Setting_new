...
using Setting_new.Filter;
using Setting_new.Entities;
using Setting_new.Authorization;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.JsonPatch;
using System.Linq.Expressions;

namespace Setting_new.Controllers
{
    /// <summary>
    ...
    {
        private readonly Setting_newContext _context;

        public RoleEntitlementController(Setting_newContext context)
        {
            _context = context;
        }
