...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Setting_new", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<Setting_newContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Setting_new API v1");
